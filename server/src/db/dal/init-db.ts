...
const categoriesWithItems: CategoryWithItems[] = [{
    ...
    itemNames: ['בית', 'בית ספר', 'יער', 'חוג', 'משחקיה', 'קניון', 'מגרש', 'חברים', 'כתה', 'קיטנה', 'סבא וסבתא', 'ברכה'
    , 'ים', 'גן חיות', 'פארק']
},{
    name: 'לימודים',
    sentenceBeginning: 'אני רוצה ',
    imageUrl: 'https://i.ibb.co/d2qNZXP/study.jpg',
    itemNames: ['מחק', 'עפרון', 'ספר', 'מספרים', 'מחברת', 'מורה', 'מורה', 'שעור', 'הפסקה', 'מחדד', 'עט', 'צבעים', 'קלמר', 'תיק']
},{
    name: 'צפייה',
